...
* fix: added Suspense boundary for index and room pages ([06d88e1](https://github.com/jkrumm/free-planning-poker/commit/06d88e1))
* fix: adjust prettier import sorting for normalize.css first ([e14eba6](https://github.com/jkrumm/free-planning-poker/commit/e14eba6))
* fix: error TRPC handling ([08de63d](https://github.com/jkrumm/free-planning-poker/commit/08de63d))
* fix: fetching feature flags is not causing hydration issue anymore ([38e2372](https://github.com/jkrumm/free-planning-poker/commit/38e2372))
* fix: handle invalid roomId in useLeaveRoomHandler ([5fc436a](https://github.com/jkrumm/free-planning-poker/commit/5fc436a))
* fix: load landing page analytics ([4130e14](https://github.com/jkrumm/free-planning-poker/commit/4130e14))
* fix: move userId sync to useEffect and remove unnecessary Suspense wrapper ([4d013a0](https://github.com/jkrumm/free-planning-poker/commit/4d013a0))
* fix: no scrollbar on room & z-indexes ([884bc48](https://github.com/jkrumm/free-planning-poker/commit/884bc48))
* fix: play sounds only when the user's Browser is ready ([62a6e7b](https://github.com/jkrumm/free-planning-poker/commit/62a6e7b))
* fix: reduce Heartbeat received for unknown user severity ([143aeb9](https://github.com/jkrumm/free-planning-poker/commit/143aeb9))
* fix: remove html overflow hide ([d919df6](https://github.com/jkrumm/free-planning-poker/commit/d919df6))
* fix: remove port from bun-email-api call and abort after 7s ([efcf9c5](https://github.com/jkrumm/free-planning-poker/commit/efcf9c5))
* fix: remove proceeding http from bun-email-api ([aeb960a](https://github.com/jkrumm/free-planning-poker/commit/aeb960a))
* fix: resolve hydration issue with fetching landing page analytics ([004f60d](https://github.com/jkrumm/free-planning-poker/commit/004f60d))
* fix: resolve multiple reported issues from Sentry ([ea8d641](https://github.com/jkrumm/free-planning-poker/commit/ea8d641))
* fix: room loader vertically centered ([a9f6e72](https://github.com/jkrumm/free-planning-poker/commit/a9f6e72))
* fix: simplify useLeaveRoomHandler ([bc06ff7](https://github.com/jkrumm/free-planning-poker/commit/bc06ff7))
* fix: update room name less db calls and higher timeout ([d35fe71](https://github.com/jkrumm/free-planning-poker/commit/d35fe71))
* fix: update to Mantine v8 setup for Next.js pages router ([45e58ea](https://github.com/jkrumm/free-planning-poker/commit/45e58ea))
* fix: use Blob for sendBeacon instead of text ([931f24f](https://github.com/jkrumm/free-planning-poker/commit/931f24f))
* fix: use Websocket reconnect mechanisms before reloading ([3f5cb91](https://github.com/jkrumm/free-planning-poker/commit/3f5cb91))
* fix(analytics): reduce to 1 fpp-analytics worker to enable Parquet file locking ([3327765](https://github.com/jkrumm/free-planning-poker/commit/3327765))
* feat: added ARCHITECTURE.md later on will be replaced by the README ([d2293f1](https://github.com/jkrumm/free-planning-poker/commit/d2293f1))
* feat: added CLAUDE.md to guide Claude Code CLI ([3440a2c](https://github.com/jkrumm/free-planning-poker/commit/3440a2c))
* feat: avoid room name collision ([9480bd2](https://github.com/jkrumm/free-planning-poker/commit/9480bd2))
* feat: disable form while waiting for email to be send ([211cc52](https://github.com/jkrumm/free-planning-poker/commit/211cc52))
* feat: display Sentry issues in the Analytics page ([92413df](https://github.com/jkrumm/free-planning-poker/commit/92413df))
* feat: improve client Sentry integration and error handling ([d2dc616](https://github.com/jkrumm/free-planning-poker/commit/d2dc616))
* feat: improve speed of update room name query ([33f6459](https://github.com/jkrumm/free-planning-poker/commit/33f6459))
* feat: improved Sentry issues table ([8f41b26](https://github.com/jkrumm/free-planning-poker/commit/8f41b26))
* feat: new active rooms table view in analytics ([9f6dbb9](https://github.com/jkrumm/free-planning-poker/commit/9f6dbb9))
* feat: responsive contact page ([116f9a8](https://github.com/jkrumm/free-planning-poker/commit/116f9a8))
* feat: switch to new fpp-server.jkrumm.com domain ([b934b2b](https://github.com/jkrumm/free-planning-poker/commit/b934b2b))
* feat: upgrade to eslint v9 ([3d5bfc1](https://github.com/jkrumm/free-planning-poker/commit/3d5bfc1))
* feat: upgrade to Next.js 16 and migrate ESLint config ([d5f1eb0](https://github.com/jkrumm/free-planning-poker/commit/d5f1eb0))
* feat: upgrade to Tailwind v4 ([e553682](https://github.com/jkrumm/free-planning-poker/commit/e553682))
* feat: upgrade to Zod v4 and improve schema validations ([de399aa](https://github.com/jkrumm/free-planning-poker/commit/de399aa))
* feat(analytics): added Sentry error tracking ([6ba7077](https://github.com/jkrumm/free-planning-poker/commit/6ba7077))
* feat(analytics): upgrade requirements.txt ([b9a964a](https://github.com/jkrumm/free-planning-poker/commit/b9a964a))
* feat(error-handling): add feedback sidebar submit modal ([aef8412](https://github.com/jkrumm/free-planning-poker/commit/aef8412))
* feat(sentry): added new Sentry projects to the frontend ([a09f1be](https://github.com/jkrumm/free-planning-poker/commit/a09f1be))
* feat(sentry): added Sentry for fpp-server ([eb2cfb1](https://github.com/jkrumm/free-planning-poker/commit/eb2cfb1))
* feat(sentry): reduce error severity for WebSocket closes ([eed8713](https://github.com/jkrumm/free-planning-poker/commit/eed8713))
* feat(typescript): moved RoomBase to shared types ([1eaf354](https://github.com/jkrumm/free-planning-poker/commit/1eaf354))
* feat(typescript): resolve fpp-server type import ([84ca669](https://github.com/jkrumm/free-planning-poker/commit/84ca669))
* chore: ignore backup files ([feed0f0](https://github.com/jkrumm/free-planning-poker/commit/feed0f0))
* chore: update dependencies ([d88dff3](https://github.com/jkrumm/free-planning-poker/commit/d88dff3))
* chore: upgrade packages ([f25873b](https://github.com/jkrumm/free-planning-poker/commit/f25873b))
* chore: upgrade to NextJS 15 and refactor Sentry client instrumentation ([88b7663](https://github.com/jkrumm/free-planning-poker/commit/88b7663))
