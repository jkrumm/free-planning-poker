      ...
      <section id="features" className="pt-24">
        ...
        <div className="feature-grid md:grid grid-cols-10 mt-12 grid-rows-6 gap-10">
          <div className="col-span-6 row-span-3 mb-8 md:mb-0">
            ...
            <div className="p-3">
              <p>
                <strong>Share Room URL</strong> - Click the room name to copy
                the URL.
              </p>
              <p>
              ...
              <p>
                <strong>Auto Show</strong> - Automatically reveal estimations
          ...
          <div className="col-span-4 row-span-7 col-start-7 mb-8 md:mb-0">
            ...
            <div className="p-3">
              <p>
                ...
                participation, efficiency, and trends in your voting sessions.
                To improve your sprint planning in the future.
              </p>
            </div>
          </div>
