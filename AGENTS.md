...
| Service | Runtime | Framework | Local Port | `.test` host | AGENTS.md |
|-|-|-|-|-|-|
| **Next.js App** | Node 24 | Next.js 16 (Pages Router) | 7720 | `fpp.test` | This file |
| **WebSocket Server** | Bun | Elysia 1.4 | 7721 | `fpp-server.test` | `apps/server/AGENTS.md` |
| **Analytics API** | Python 3.14 | FastAPI | 7722 | `fpp-analytics.test` | `fpp-analytics/AGENTS.md` |
...
- **React 19.3.0** with stricter linting rules
- **tRPC 11.19.0** for type-safe API layer
